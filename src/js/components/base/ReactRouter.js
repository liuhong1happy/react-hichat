...
var Link = React.createClass({
    ...
    render:function(){
        ...
        if(props.anchor){
                return (<a title={props.title} data-target={props["data-target"]} className={"link"+(props.className?" "+props.className:"")+(props.active?" active":"")}  onClick={this.handleClick} style={props.style}>
                                { props.children }
                        </a>)
        }else{
                return (<div title={props.title} data-target={props["data-target"]}  className={"link"+(props.className?" "+props.className:"")+(props.active?" active":"")}  onClick={this.handleClick} style={props.style}>
                        { props.children }
                </div>)
        }
